            ...
            return (
                <View style={{ width: '100%', alignItems: 'center' }}>
                    ...
                    <View style={{ width: '95%' }}>
                        ...
                        <Text style={{ fontSize: 14, color: '#333', fontFamily: 'Poppins-Regular', lineHeight: 25, paddingVertical: 10 }}>Albion is the most trusted portal in India for auction of bank foreclosed properties including movable and immovable properties. Almost all the leading public sector as well as private banks have used our portal for auctioning their NPAs. For buyers, our portal provides opportunity to own a property at a price substantially lower than market price.</Text>
                    </View>
                ...
                <View style={{ width: '100%', alignItems: 'center', paddingHorizontal: 10, paddingBottom: 20 }}>
                    <View style={{ width: '95%', paddingVertical: 10 }}>
                        <View style={{ width: '100%', flexDirection: 'row', alignItems: 'center' }}>
                            ...
                            <Text style={{ fontSize: 14, color: '#000', textAlign: 'justify', marginHorizontal: 10, fontFamily: 'Poppins-SemiBold', }}>What is e-Auction? When should Forward and Reverse Auction be used?</Text>
                        </View>
                        <Text style={{ width: '100%', fontSize: 13, color: '#666', textAlign: 'justify', paddingVertical: 10, fontFamily: 'Poppins-Regular', lineHeight: 20 }}>e-Auctions are negotiations conducted via an online platform where Suppliers get the possibility of improving their proposals based on market feedback (e.g. rank in negotiation) and are considered to be the most transparent way of conducting negotiations. Basically, there are two types of Auctions.</Text>

                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            <View style={{ width: 5, height: 5, backgroundColor: '#666', borderRadius: 50 }}></View>
                            <Text style={{ fontSize: 14, color: '#333', textAlign: 'justify', marginHorizontal: 10, fontFamily: 'Poppins-Regular', }}>Forward Auction</Text>
                        </View>
                        ...
                        <Text style={{ width: '100%', fontSize: 13, color: '#666', textAlign: 'justify', paddingVertical: 5, fontFamily: 'Poppins-Regular', lineHeight: 20 }}>For example, when a Bank or a Debt Recovery Tribunal (DRT) hold an auction to sell a property or an asset - it will use Forward Auction mechanism.</Text>

                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            <View style={{ width: 5, height: 5, backgroundColor: '#666', borderRadius: 50 }}></View>
                            <Text style={{ fontSize: 14, color: '#333', textAlign: 'justify', marginHorizontal: 10, fontFamily: 'Poppins-Regular', }}>Reverse Auction</Text>
                        </View>
                    ...
                    <View style={{ width: '95%', paddingVertical: 10 }}>
                        <View style={{ width: '100%', flexDirection: 'row', alignItems: 'center' }}>
                            ...
                            <Text style={{ fontSize: 14, color: '#000', textAlign: 'justify', marginHorizontal: 10, fontFamily: 'Poppins-SemiBold', }}>Who is a Bidder?</Text>
                        </View>
                    ...
                    <View style={{ width: '95%', paddingVertical: 10 }}>
                        <View style={{ width: '100%', flexDirection: 'row', alignItems: 'center' }}>
                            ...
                            <Text style={{ fontSize: 14, color: '#000', textAlign: 'justify', marginHorizontal: 10, fontFamily: 'Poppins-SemiBold', }}>Are the Auction Events Private or public? How confidential is the Auction data?</Text>
                        </View>
                    ...
                    <View style={{ width: '95%', paddingVertical: 10 }}>
                        <View style={{ width: '100%', flexDirection: 'row', alignItems: 'center' }}>
                            ...
                            <Text style={{ fontSize: 14, color: '#000', textAlign: 'justify', marginHorizontal: 10, fontFamily: 'Poppins-SemiBold', }}>Can an individual who is not a registered company or an organization, register as a Bidder?</Text>
                        </View>
                    ...
                    <View style={{ width: '95%', paddingVertical: 10 }}>
                        <View style={{ width: '100%', flexDirection: 'row', alignItems: 'center' }}>
                            ...
                            <Text style={{ fontSize: 14, color: '#000', textAlign: 'justify', marginHorizontal: 10, fontFamily: 'Poppins-SemiBold', }}>Forgotten user name and / or password: How to retrieve the same?</Text>
                        </View>
                    ...
                    <View style={{ width: '95%', paddingVertical: 10 }}>
                        <View style={{ width: '100%', flexDirection: 'row', alignItems: 'center' }}>
                            ...
                            <Text style={{ fontSize: 14, color: '#000', textAlign: 'justify', marginHorizontal: 10, fontFamily: 'Poppins-SemiBold', }}>Which Internet Browser should be used? Which is the most suitable Internet Browser for Bank or DRT Auctions?</Text>
                        </View>
